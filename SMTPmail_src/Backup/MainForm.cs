...
namespace SMTPmail
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.ServSMTP.Text = "smtp.your server.com";
			// 
			// sFrom
			// 
			...
			this.sFrom.Text = "sender@host.com";
			// 
			// sTo
			// 
			...
			this.sTo.TabIndex = 4;
			this.sTo.Text = "receiver@host.com";
			// 
			// sSubject
			// 
			...
			this.sSubject.Text = "subject mail";
			// 
			// sMessage
			// 
			...
			this.sMessage.Size = new System.Drawing.Size(280, 136);
			this.sMessage.TabIndex = 6;
			this.sMessage.Text = "your message";
			// 
			// LogList
			// 
			this.LogList.Location = new System.Drawing.Point(8, 312);
			this.LogList.Name = "LogList";
			this.LogList.ScrollAlwaysVisible = true;
			this.LogList.Size = new System.Drawing.Size(280, 69);
